...
This guide explains how to configure MongoDB so the bot persists **users**, **proxies**, **sites/URLs**, **subscriptions**, **plan requests**, **redeems**, **groups**, and **Stripe Auth gate** (epicalarc/shavercity).  
