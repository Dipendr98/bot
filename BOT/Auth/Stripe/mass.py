...
async def handle_mau_command(client, message):
    """Handle mass Stripe Auth command: $mau with multiple cards"""
...
<b>You have to register first using</b> <code>/register</code> <b>command.</b>""",
        ...
        if not target_text:
            return await message.reply(
                "❌ <b>Send cards!</b>\n1 per line:\n<code>4744721068437866|12|29|740</code>",
                reply_to_message_id=message.id
            )
...
<b>Type <code>/buy</code> to get Credits.</b>""",
        ...
        gateway = "M-Stripe Auth [EcologyJobs]"
...
━━━━━━━━━━━━━━━"""
        ...
        print(f"Error in $mau command: {str(e)}")
        try:
            await message.reply(
