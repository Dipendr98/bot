...
def get_status_flag(raw_response):
    if "ORDER_PLACED" in raw_response or "Thank You" in raw_response:
        ...
        "insufficient funds", "INVALID_CVC", "INCORRECT_CVC", "3DS_REQUIRED", "MISMATCHED_BILL"
    ]):
        return "Approved ✅"
    else:
        return "Declined ❌"
...
@Client.on_message(filters.command("mslf") | filters.regex(r"^\.mslf(\s|$)"))
